...
<template>
    <div class="card">
        <DataTable v-model:filters="filters" v-model:selection="selectedCustomers" :value="products" paginator :rows="10" dataKey="id" filterDisplay="menu"
            ...
            <template #footer> {{ products ? products.length : 0 }} produtos encontrados. </template>
        </DataTable>
    </div>
</template>
