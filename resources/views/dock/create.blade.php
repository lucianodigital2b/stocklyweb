<x-app-layout>
    ...
    <div class="row">
        <form action="{{ route('docks.store') }}" method="post" class="col-sm-12 col-lg-12">
            @csrf
                                    ...
                                    <select class="products-multiple form-control" name="shipping_policies[]"
                                        ...
                                        @foreach ($shippings as $shipping)
                                            <option value="{{$shipping->id}}"
                                                @if ( old('shipping_policies') && 
                                                        is_array(old('shipping_policies')) && 
                                                        in_array($shipping->id, old('shipping_policies')) ) selected @endif>
                                ...
                                <div>
                                    ...
                                    <select class="products-multiple form-control" name="store_fronts[]" multiple="multiple">
                                        @foreach ($apps as $app)
                                            <option value="{{$app->id}}" 
                                                @if ( old('store_fronts') && 
                                                        is_array(old('store_fronts')) && 
                                                        in_array($app->id, old('store_fronts')) ) selected @endif>
                                                {{$app->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-md-11">
                                                    ...
                                                    <input type="number" class="form-control" value="0" name="service_time_days">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="col">
                                                    <label for="service_time_hours" class="form-label"><small>Horas e minutos</small></label>
                                                    <input type="time" class="form-control" id="service_time_hours" name="service_time_hours">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-md-11">
                                                    ...
                                                    <input type="number" class="form-control" value="0" name="overhead_days" id="overhead_days">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="col">
                                                    <label for="overhead_hours" class="form-label"><small>Horas e minutos</small></label>
                                                    <input type="time" class="form-control" name="overhead_hours" id="overhead_hours">
                                                </div>
                                            </td>
                            ...
                            <div class="col">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input class="form-control" name="postal_code" id="postal_code" type="text" value="{{ old('postal_code') }}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 col-md-4">
                                        ...
                                        <input class="form-control" name="address_number" id="address_number" type="text" value="{{ old('address_number') }}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input class="form-control" name="address_complement" id="address_complement" type="text" value="{{ old('address_complement') }}">
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label" for="neighborhood">Bairro</label>
                                        <input class="form-control" name="neighborhood" id="neighborhood" type="text" value="{{ old('neighborhood') }}">
                                    </div>
                                </div>
